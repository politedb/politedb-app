...
export function TableStructurePane(props: {
  ...
  const activeSearchValue =
    structPaneTab === "constraints" ? constraintSearch : columnSearch;
        ...
        <div class="flex items-center gap-4">
          ...
          <Input
            ...
            onInput={(e) => {
              ...
              if (structPaneTab === "constraints") {
                setConstraintSearch(value);
              } else {
            ...
            className="h-7 flex-1 border border-neutral-200 bg-white text-sm"
