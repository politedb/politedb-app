...
export type ConnectionRuntime = {
  ...
  /** When set by context menu, MainTableDataPane runs export/import then clears */
  pendingTableAction: "export" | "import" | null;
  setPendingTableAction: (action: "export" | "import" | null) => void;
};
